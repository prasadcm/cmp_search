...
class Settings(BaseSettings):
    ...
    previously_searched_index_name: str = Field(
        default="previously-searched-item-index-001"
    )
    search_suggestion_index_name: str = Field(default="search-suggestion-index-001")
